 ...
 */
package moscow.ptnl.contingent.endpoint.history;

import static moscow.ptnl.contingent.configuration.HistoryConfiguration.HISTORY_EVENT_CHANNEL_NAME;
...
public class HistoryEndpoint {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(HistoryEndpoint.class);
    ...
    public void historyEventConsumer(Message<HistoryEvent> msg) {
        LOG.info("RECIVE MESSAGE: {}", msg.getPayload().getTypeId().name());
        try {
