...
public enum AreaErrorReason implements ErrorReason {
    ...
    ADDRESS_ALREADY_SERVICED_ANOTHER_AREA("E018", "Адрес уже обслуживается участком с ИД %s. Адрес, включенный в территорию обслуживания участка, не должен входить в территорию обслуживания другого участка с ИД типа участка %s"),
