    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = 1234567890L;
        @XmlElement(name = "stackTraceRecord", required = true)
        protected List<UnexpectedFault.StackTrace.StackTraceRecord> stackTraceRecords;

        /**
         * Gets the value of the stackTraceRecords property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the stackTraceRecords property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getStackTraceRecords().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<UnexpectedFault.StackTrace.StackTraceRecord> getStackTraceRecords() {
            if (stackTraceRecords == null) {
                stackTraceRecords = new ArrayList<UnexpectedFault.StackTrace.StackTraceRecord>();
            }
            return this.stackTraceRecords;
        }
