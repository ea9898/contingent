...
public class SearchAreaTest {
    ...
    @Test
    @Sql(scripts = {"/sql/searchAreaTest.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    ...
    @Test
    @Sql("/sql/searchAreaTest.sql")
    public void searchAreaByMedicalEmployeesTest() {
    }

    @Test
    @Sql("/sql/searchAreaTest.sql")
    public void searchAreaByAddressesTest() {
    }
}
