...
public class SetMedicalEmployeeOnAreaTest extends BaseTest {
    ...
    private Optional<PositionNom> positionNom;
...
//        specialization = new Specialization(5L, "Хирургия", false);
        ...
        positionNom = Optional.of(new PositionNom(7L, "врач-хирург", LocalDate.now(), null));
        positionCode = Optional.of(new PositionCode(10L, "testNom", 12345L, "testPositionCode", "testTitle"));
        employee1 = new AreaMedicalEmployees(1L, 1L, area1, true, LocalDate.of(2019, 1, 10), null, "123", positionCode, LocalDateTime.now(), null, 1L);
        employee2 = new AreaMedicalEmployees(2L, 1L, area1, false, LocalDate.of(2019, 2, 3), LocalDate.of(2019, 2, 10), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee3 = new AreaMedicalEmployees(3L, 3L, area1, false, LocalDate.of(2019, 3, 2), LocalDate.of(2019, 3, 10), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee4 = new AreaMedicalEmployees(4L, 4L, area1, false, LocalDate.of(2019, 3, 5), null, "123", positionCode, LocalDateTime.now(), null, 1L);
        employee5 = new AreaMedicalEmployees(5L, 5L, area2, false, LocalDate.of(2019, 3, 5), LocalDate.of(2019, 3, 15), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee6 = new AreaMedicalEmployees(6L, 6L, area2, false, LocalDate.of(2019, 5, 1), LocalDate.of(2019, 5, 10), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee7 = new AreaMedicalEmployees(7L, 7L, area2, false, LocalDate.of(2019, 5, 10), LocalDate.of(2019, 5, 20), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee8 = new AreaMedicalEmployees(8L, 7L, area2, false, LocalDate.of(2019, 2, 3), LocalDate.of(2019, 2, 10), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee9 = new AreaMedicalEmployees(9L, 7L, area2, false, LocalDate.of(2019, 3, 5), LocalDate.of(2019, 3, 11), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee10 = new AreaMedicalEmployees(10L, 7L, area2, true, LocalDate.of(2019, 3, 11), LocalDate.of(2019, 3, 20), "123", positionCode, LocalDateTime.now(), null, 1L);
        employee11 = new AreaMedicalEmployees(11L, 7L, area2, true, LocalDate.of(2019, 2, 10), LocalDate.of(2019, 3, 5), "123", positionCode, LocalDateTime.now(), null, 1L);
