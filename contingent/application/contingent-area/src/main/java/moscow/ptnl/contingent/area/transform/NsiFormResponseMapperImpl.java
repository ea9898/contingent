...
@Component
public class NsiFormResponseMapperImpl implements NsiFormResponseMapper {

    private final static Logger LOG = LoggerFactory.getLogger(NsiFormResponseMapperImpl.class);
    ...
    private String mapSimpleField(Node valueNode) {
        ...
        return values.getLength() > 0 ?
                XMLUtil.asList(values).stream()
                        ...
                        .map(NsiFormResponseMapperImpl::valueToString)
                        .distinct()
