...
import ru.mos.emias.contingent2.address.v3.NameWithType;

@Mapper(componentModel="spring")
public interface AddressRegistryToAddressRegistryBaseMapperV3 {

    AddressRegistryToAddressRegistryBaseMapperV3 MAPPER = Mappers.getMapper(AddressRegistryToAddressRegistryBaseMapperV3.class);
