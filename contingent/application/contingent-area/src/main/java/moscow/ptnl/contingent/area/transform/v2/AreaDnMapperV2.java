...
import ru.mos.emias.contingent2.core.v2.PositionNomClinic;
import ru.mos.emias.contingent2.core.v2.AreaDn;
import ru.mos.emias.contingent2.core.v2.Specialization;
...
@Component
public class AreaDnMapperV2 implements Transform<AreaDn, AreaInfo> {
    ...
    public AreaDn entityToDtoTransform(AreaInfo entityObject) {
        ...
        area.setAreaTypeProfile(codeNameTypeMapper.entityToDtoTransform(areaObject.getAreaTypeProfile(), AreaTypeProfile.class));
