...
@Proxy(lazy=false)
@SequenceGenerator(name = "SEQ_AREA_CLOSE_REASONS", sequenceName = "SEQ_AREA_CLOSE_REASONS", allocationSize=1)
public class AreaCloseReasons implements Serializable {

    private static final long serialVersionUID = -351542960775621498L;

    @Id
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="SEQ_AREA_CLOSE_REASONS")
